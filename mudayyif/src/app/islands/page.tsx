    ...
    <div className="min-h-screen bg-creamPistachio text-darkAzure font-sans">
      ...
      <nav className="w-full flex items-center justify-between px-8 py-6 bg-white/90 backdrop-blur-md shadow-sm fixed top-0 left-0 z-50">
        ...
        <div className="flex items-center gap-8">
          ...
          <a href="/islands" className="text-azure font-semibold">Islands</a>
      ...
      <section className="pt-40 pb-20 px-6">
        <div className="max-w-6xl mx-auto">
          <h1 className="text-5xl font-extrabold mb-8 text-center text-darkAzure">Abu Dhabi Islands</h1>
          <p className="text-xl text-center text-azure mb-12 max-w-3xl mx-auto">
            Discover the stunning islands that make Abu Dhabi a unique destination. From cultural heritage to modern luxury, each island offers its own distinct experience.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition">
              <div className="h-48 bg-gradient-to-br from-azure to-darkAzure flex items-center justify-center">
                <h3 className="text-2xl font-bold text-white">Yas Island</h3>
              </div>
              <div className="p-6">
                <h4 className="text-xl font-semibold mb-3 text-darkAzure">Entertainment Capital</h4>
                <p className="text-gray-600 mb-4">Home to Ferrari World, Yas Waterworld, and world-class entertainment venues.</p>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition">
              <div className="h-48 bg-gradient-to-br from-darkAzure to-azure flex items-center justify-center">
                <h3 className="text-2xl font-bold text-white">Saadiyat Island</h3>
              </div>
              <div className="p-6">
                <h4 className="text-xl font-semibold mb-3 text-darkAzure">Cultural District</h4>
                <p className="text-gray-600 mb-4">A cultural hub featuring museums, galleries, and pristine beaches.</p>
                <button className="bg-azure text-white px-4 py-2 rounded-full hover:bg-darkAzure transition">Explore</button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition">
              <div className="h-48 bg-gradient-to-br from-azure to-creamPistachio flex items-center justify-center">
                <h3 className="text-2xl font-bold text-darkAzure">Al Reem Island</h3>
              </div>
              <div className="p-6">
                <h4 className="text-xl font-semibold mb-3 text-darkAzure">Modern Living</h4>
                <p className="text-gray-600 mb-4">A modern residential and business district with stunning waterfront views.</p>
                <button className="bg-azure text-white px-4 py-2 rounded-full hover:bg-darkAzure transition">Explore</button>
              </div>
            </div>
          </div>
